...
import random
import time
from modelTransformer import TransAm
import onnx
import onnxruntime
import MNN
...
def train(device, input_num, output_num, debug = False,pretrained=False):
    ...
    if pretrained:
        ...
        model = TransAm(input_size, input_num, output_num).to(device, dtype=torch.float64)
